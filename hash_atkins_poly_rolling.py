#Implementing a hashing function that utilizes the seive of atkins to generate a prime modulus which
#is then used in polynomial rolling of string keys in python.
...
def sieve(limit):
    ...
    return [i for i in range(2, limit + 1) if res[i]]
