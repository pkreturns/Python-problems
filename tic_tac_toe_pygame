# Pygame implementation of a Tic Tac Toe game with dimensions 400x500. 
# The game will wait and then reset whenever there is a draw or one of the players wins.
#  When a player wins, it generates a red line crossing all three squares that were a part of the winning move.
